...
def ask(question:str ="Soy <Async> en qué puedo ayudarte", history=[["", ""]]):
...
def main():
    ...
    while True:
        prompt = input("Soy <Async> Qué pregunta tienes (o Enter para salir): ")
        if prompt == "":
            break
    ...
    #ui = gr.ChatInterface(fn=ask, textbox=gr.Textbox(placeholder="Soy <Async> y puedes preguntar sobre temas relacionados los reglamentos de la facultad y al funcionamiento cátedra de Ingeniería de Software, así como también sobre las materias de Diseño de Aplicaciones 1 y Fundamentos de ingeniería", container=True, max_lines=10), title="Tag - el chatbot de la cátedra de IngSoft",
